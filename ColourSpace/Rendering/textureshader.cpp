...
#if _DEBUG
	result = InitialiseShader(device, hwnd, L"../ColourSpace/texture.vs", L"../ColourSpace/texture.ps");
#else
	result = InitialiseShader(device, hwnd, L"shaders/texture.vs", L"shaders/texture.ps");
#endif
	if(!result)
	{
		return false;
